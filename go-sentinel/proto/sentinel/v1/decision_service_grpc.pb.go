...
const (
	DecisionService_GetAction_FullMethodName = "/sentinel.decision.v1.DecisionService/GetAction"
)
...
func (c *decisionServiceClient) GetAction(ctx context.Context, in *GetActionRequest, opts ...grpc.CallOption) (*GetActionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetActionResponse)
	err := c.cc.Invoke(ctx, DecisionService_GetAction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDecisionServiceServer) GetAction(context.Context, *GetActionRequest) (*GetActionResponse, error) {
...
func _DecisionService_GetAction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DecisionServiceServer).GetAction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DecisionService_GetAction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DecisionServiceServer).GetAction(ctx, req.(*GetActionRequest))
	}
...
var DecisionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sentinel.decision.v1.DecisionService",
	HandlerType: (*DecisionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetAction",
			Handler:    _DecisionService_GetAction_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/sentinel/v1/decision_service.proto",
}
